...
export const Header = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 bg-black z-40 flex flex-col items-center justify-center gap-6 text-white">
          ...
          <div className="flex flex-col gap-4 text-sm w-full px-10">
            <Link href="/consutation" className="group flex items-center justify-center gap-1 px-4 py-2 border border-orange-400 rounded-lg font-semibold text-sm bg-linear-to-r from-orange-600 via-orange-500 to-orange-400 text-white">Book a Consultation <IoIosArrowForward /></Link>
